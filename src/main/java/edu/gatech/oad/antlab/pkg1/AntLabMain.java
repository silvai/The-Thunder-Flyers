 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Ella Silva");
		  toPrint += p1.toString("isilva3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Ritvik Khanna");
		  toPrint += p2.toString("rkhanna31");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Sri Bhat");
		  toPrint += p3.toString("sbhat45");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Drew Salazar");
          toPrint += p4.toString("asalazar35");
          //Person5 replace P5 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Steven Nguyen");
          toPrint += p5.toString("snguyen64");
		  //Person6 replace P6 with your name
          //and gburdell5 with your gt id
          Person6 p6 = new Person6("Leon Zhu");
          toPrint += p6.toString("lzhu91");
